...
def move():
	...
	time.sleep(3)
	## green_obj_place_better
	joint_point.positions = [0.7850, 1.0149, 0.2414, 0.0000, 1.7749, 0.0000]
	arm_cmd.points = [joint_point]
	move_pub.publish(arm_cmd)
	...
	print('Message Published!!! : Moved to obj_2_lift')
	time.sleep(3)
	## blue_obj_place_better
	joint_point.positions = [-1.9625, 1.0149, 0.2414, 0.0000, 1.7749, 0.0000]
	arm_cmd.points = [joint_point]
	move_pub.publish(arm_cmd)
	...
	print('Message Published!!! : Moved to obj_3_lift')
	time.sleep(3)
	## red_obj_place_better
	joint_point.positions = [2.3550, 1.0149, 0.2414, 0.0000, 1.7749, 0.0000] 
	arm_cmd.points = [joint_point]
	move_pub.publish(arm_cmd)
	...
	joint_point.positions = [-2.0275, 1.0149, 0.2414, 0.0000, 1.7749, 0.0000]
	arm_cmd.points = [joint_point]
	move_pub.publish(arm_cmd)
	print('Message Published!!! : Moved to blue_obj_place')
	time.sleep(3)
	...
	joint_point.positions = [-1.8975, 1.0149, 0.2414, 0.0000, 1.7749, 0.0000]
	arm_cmd.points = [joint_point]
	move_pub.publish(arm_cmd)
	print('Message Published!!! : Moved to blue_obj_place')
	time.sleep(3)
	...
	joint_point.positions = [0.9150, 1.0149, 0.2414, 0.0000, 1.7749, 0.0000]
	arm_cmd.points = [joint_point]
	move_pub.publish(arm_cmd)
	print('Message Published!!! : Moved to green_obj_place')
	time.sleep(3)
	...
	joint_point.positions = [2.2900, 1.0149, 0.2414, 0.0000, 1.7749, 0.0000]
	arm_cmd.points = [joint_point]
	move_pub.publish(arm_cmd)
	print('Message Published!!! : Moved to red_obj_place')
	time.sleep(3)
